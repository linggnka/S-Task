			...
			<div class="row">
				<div class="card">
					<div class="card-header pb-0">
						<a href="<?= base_url(); ?>kedatangan" class="text-danger text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Lewati</a>
						<h6 class="montserrat mt-4">Masukkan Hasil Tangkapan Kapal <?php echo $berangkat->nama_kapal; ?> - <?php echo $berangkat->GT; ?> GT</h6>
						<form action="<?php echo base_url().'user/insert_ikan'; ?>" method="post">
