	...
	<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
		...
		<div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link  " href="<?= base_url(); ?>user/datakapal_userr">
						<div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
				...
				<div class="col-12 mt-3">
					<div class="card mb-4">
						<div class="card-header">
							<div class="row">
								<div class="col-md-6">
									<h6 class="fw-bold montserrat mb-3">Hasil Tangkapan <?php echo $kapal->nama_kapal; ?></h6>
								</div>
							...
							<div class="card-body px-0 pt-0 pb-2">
								<div class="table-responsive p-0">
										...
										<tbody>
											...
											<tr>
												...
												<td class="px-4">
													<div class="d-flex">
														<div class="d-flex flex-column">
															<p class="mb-0 text-sm font-weight-bold opacity-9"><?php echo $row['jenis_ikan'] ?></p>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<a href="<?= base_url(); ?>edit_ikan/<?= $row['id_hasil'];?>" class="btn btn-link text-dark px-3 mb-0">
														<i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>
														Edit
													</a>
													<a href="<?= base_url(); ?>hapus_ikan/<?= $row['id_hasil'];?>" class="btn btn-link text-danger text-gradient px-3 mb-0">
									...
									<div class="mt-3" id="">
										<a class="btn bg-gradient-dark mb-0" href="<?= base_url(); ?>tambah_ikan/<?= $row['id_out'];?>">
