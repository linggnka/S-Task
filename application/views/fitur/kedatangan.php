			...
			<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 justify-content-end" id="navbar">
				<ul class="navbar-nav justify-content-end">
					...
					<li class="nav-item d-flex align-items-center px-3">
						<a href="" class="nav-link text-body font-weight-bold px-0" data-bs-toggle="modal" data-bs-target="#kapal_baru">
				...
				<div class="col-12 mt-3">
					<div class="card mb-4">
						<div class="card-header pb-0 p-5">
							<h6 class="fw-bolder mb-4">Catat Kedatangan Berdasarkan Data Keberangkatan</h6>
												...
												<td class="px-4">
													<div class="d-flex">
														<div class="d-flex flex-column">
															...
															<a href="<?= base_url(); ?>inputdatang/<?= $row['id_out'];?>" class="btn btn-link text-dark p-0 pt-2 mb-0 text-start">
									...
									<form action="<?php echo base_url().'user/insert_kapal'; ?>" method="post">
										<div class="row">
											...
											<div class="col-sm-3 mb-3">
												...
												<select class="form-select" name="kelompok_gt">
													...
													<option value="31-50 GT">31-50 GT</option>
													<option value="51-100 GT">51-100 GT</option>
										...
										<div class="row mb-3">
											<div class="col-md-6">
												...
												<input type="text" class="form-control" name="nama_nahkoda" id="nama_nahkoda" placeholder="" required="">
											</div>
											<div class="col-md-6">
										...
										<div class="row d-flex">
											<div class="col-md-6 mb-3">
												...
												<select class="form-select" name="alat_tangkap" placeholder="Pilih Alat Tangkap" required="">
													<option></option>
										...
										<div class="row">
											<div class="col-sm-6 mb-3">
												...
												<input type="text" class="form-control" name="jenis_izin" id="jenis_izin" placeholder="Cont: Daerah/Pusat">
											</div>
											<div class="col-sm-6 mb-3">
