					...
					<div class="card mb-4">
						<div class="card-header pb-0 p-5">
							<div class=" border-radius-lg d-flex justify-content-end flex-row">
								<a href="<?= base_url(); ?>user/excel_kapal"
									class="btn btn-link text-dark text-sm mb-0 px-0 ms-4 pt-0">
									...
									<table class="table table-hover align-items-center mb-0">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="rincian_kapal/<?= $row['id_kapal'];?>" class="btn btn-outline-primary btn-sm mb-0">Rincian</a>
												</td>
												<td>
