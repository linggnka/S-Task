				...
				<div class="col-12">
					<div class="card mb-4">
						<div class="card-header pb-0 p-sm-5">
							<h6 class="montserrat">Profil Kapal</h6>
							<form method="post" action="<?php echo base_url(); ?>user/aksi_edit">
								<input type="hidden" name="id_kapal" id="id_kapal" value="<?php echo $kapal->id_kapal; ?>" />
								<div class="container p-4">
									<div class="row">
										<div class="col-sm-6 mb-3">
											<label for="nama_kapal" class="">Nama Kapal</label>
											<input type="text" class="form-control" name="nama_kapal" id="nama_kapal" placeholder="" value="<?= $kapal->nama_kapal; ?>" required>
										</div>
										<div class="col-sm-3 mb-3">
											<label for="gt" class="">GT Kapal</label>
											<input type="text" class="form-control" name="gt" id="gt" placeholder="" value="<?= $kapal->GT; ?>" required>
										</div>
										<div class="col-sm-3 mb-3">
											<label for="kelompok_gt" class="">Kelompok GT</label>
											<select class="form-select" name="kelompok_gt">
												<option value="<?= $kapal->kelompok_gt; ?>"><?= $kapal->kelompok_gt; ?></option>
												<option value="5-10 GT"><5 GT</option> 
									...
									<div class="row">
										<div class=" col-sm-6 mb-3">
											...
											<input type="text" class="form-control" name="nama_pemilik" id="nama_pemilik" placeholder="" value="<?= $kapal->nama_pemilik; ?>" required="">
										</div>
										<div class="col-sm-6 mb-3">
											<label for="no_hp_pemilik" class="">No. HP Pemilik</label>
											<input type="text" class="form-control" name="no_hp_pemilik" id="no_hp_pemilik" placeholder="" value="<?= $kapal->no_hp_pemilik; ?>" required="">
										</div>
									</div>
									<div class="row ">
										<label for="" class="">Waktu Daftar</label>
										<div class="col-md mb-3">
											<input type="date" class="form-control" name="tanggal_daftar" placeholder="" value="<?= $kapal->tanggal_daftar; ?>" required>
										</div>
										<div class="col-md mb-3">
											<input type="time" class="form-control" name="waktu_daftar" placeholder="" value="<?= $kapal->waktu_daftar; ?>" required>
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-md-6">
											<label for="nama_nahkoda" class="">Nama Nahkoda</label>
											<input type="text" class="form-control" name="nama_nahkoda" id="nama_nahkoda" placeholder="" value="<?= $kapal->nama_nahkoda; ?>">
										</div>
										<div class="col-md-6">
											...
											<input type="number" class="form-control" name="abk" id="abk" placeholder="" required="" value="<?= $kapal->abk; ?>">
										</div>
									</div>
									...
									<div class="row d-flex">
										<div class="col-md-6 mb-3">
											...
											<select class="form-select" name="alat_tangkap" placeholder="Pilih Alat Tangkap">
												<option value="<?= $kapal->alat_tangkap; ?><?= $kapal->alat_tangkap2; ?>"><?= $kapal->alat_tangkap; ?><?= $kapal->alat_tangkap2; ?></option>
										...
										<div class="col-md-6">
											...
											<input type="text" class="form-control" name="alat_bantu_tangkap" id="alat_bantu_tangkap" value="<?= $kapal->alat_bantu_tangkap; ?>" placeholder="">
										</div>
									</div>
									<div class="row ">
										<div class="col-md-6 mb-3">
											<label for="jenis_kapal" class="">Jenis Kapal</label>
											<select class="form-select" name="jenis_kapal" value="" required>
												<option value="<?= $kapal->jenis_kapal; ?>"><?= $kapal->jenis_kapal; ?></option>
												<option value="Motor Tempel">Motor Tempel</option>
												<option value="Kapal Motor">Kapal Motor</option>lainnya
											</select>
										</div>
										<div class=" col-md-3 mb-3">
											...
											<input type="text" class="form-control" name="panjang_kapal" id="panjang_kapal" placeholder="" value="<?= $kapal->panjang_kapal; ?>">
										</div>
										<div class=" col-md-3 mb-3">
											<label for="status_kapal" class="">Status Kapal</label>
											<input type="text" class="form-control" name="status_kapal" id="status_kapal" placeholder="" value="<?= $kapal->status_kapal; ?>" required>
										</div>
									</div>
									<div class="row ">
										<div class="col-md-6 b-3">
											<label for="mesin_utama" class="">Mesin Utama (PK)</label>
											<input type="text" class="form-control" name="mesin_utama" id="mesin_utama" placeholder="" value="<?= $kapal->mesin_utama; ?>">
										</div>
										<div class=" col-md-6 mb-3">
											<label for="tanda_selar" class="">Tanda Selar</label>
											<input type="text" class="form-control" name="tanda_selar" id="tanda_selar" placeholder="" value="<?= $kapal->tanda_selar; ?>">
										</div>
									</div>
									<div class="row ">
										<div class=" col-md-6 mb-3">
											<label for="jenis_izin" class="">Jenis Izin</label>
											<input type="text" class="form-control" name="jenis_izin" id="jenis_izin" placeholder="" value="<?= $kapal->jenis_izin; ?>">
										</div>
										<div class="col-md-6 b-3">
											<label for="izin_WPP" class="">Izin WPP</label>
											<input type="text" class="form-control" name="izin_WPP" id="izin_WPP" placeholder="" value="<?= $kapal->izin_WPP; ?>">
										</div>
									</div>
									<div class="row ">
										<div class=" col-md-6 mb-3">
											<label for="izin_PP" class="">Izin Pelabuhan Pangkalan</label>
											<input type="text" class="form-control" name="izin_PP" id="izin_PP" placeholder="" value="<?= $kapal->izin_PP; ?>">
										</div>
										<div class="col-md-6 b-3">
											<label for="izin_AT" class="">Izin Alat Tangkap</label>
											<input type="text" class="form-control" name="izin_AT" id="izin_AT" placeholder="" value="<?= $kapal->izin_AT; ?>">
										</div>
									</div>
									<button class="btn bg-dark text-white mt-3 rounded-pill float-end" type="submit" value="register" name="register">EDIT</button>
								</div>
							</form>
						</div>
								...
								<div class="card-body pb-0 px-5">
									<form method="post" action="<?php echo base_url(); ?>user/aksi_edit">
										...
										<div class="row">
											...
											<div class="col-sm-6 mb-3">
												<label for="no_hp_pemilik" class="">No. HP Pemilik</label>
												<input type="text" class="form-control" name="no_hp_pemilik" id="no_hp_pemilik" placeholder=""
													required="">
											</div>
										</div>
										<div class="row">
