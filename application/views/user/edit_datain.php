...
<body class="g-sidenav-show">
	...
	<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
		<div class="sidenav-header">
			...
			<a class="navbar-brand m-0" href="k">
				...
				<div class="col-12">
					<div class="card mb-4">
						<div class="card-header pb-0 p-sm-5">
							...
							<form method="post" action="<?php echo base_url(); ?>user/aksi_editdatain">
								<input type="hidden" name="id_in" id="id_in" value="<?php echo $in->id_in; ?>" />
										...
										<div class="container-fluid">
											<div class="row">
												...
												<div class="col-md mb-3">
													<input type="date" class="form-control" name="tanggal_in" id="tanggal_in" placeholder="" value="<?php echo $in->tanggal_in; ?>" required="">
												</div>
												<div class="col-md mb-3">
													<input type="time" class="form-control" name="waktu_in" id="waktu_in" placeholder="" value="<?php echo $in->waktu_in; ?>" required="">
												</div>
											</div>
											<div class="row">
												<div class="col-sm-6 mb-3">
													<label for="jumlah_hari_trip" class="">Jumlah Hari Trip</label>
													<input type="text" class="form-control" name="jumlah_hari_trip" id="jumlah_hari_trip" placeholder="" value="<?php echo $in->jumlah_hari_trip; ?>">
												</div>
												<div class="col-sm-6 mb-3">
													<label for="lokasi_in" class="">Lokasi Kedatangan</label>
													<select class="form-select" name="lokasi_in" placeholder="" required="">
														<option value="<?php echo $in->lokasi_in; ?>"><?php echo $in->lokasi_in; ?></option>	
											...
											<div class="row">
												<div class="col-sm-6 mb-3">
													<label for="kegiatan" class="">Kegiatan di Pelabuhan</label>
													<select class="form-select" name="kegiatan" placeholder="">
														<option value="<?php echo $in->kegiatan; ?>"><?php echo $in->kegiatan; ?></option>
														<option value="Bongkar Ikan">Bongkar Ikan</option>
												...
												<div class="">
													<label for="lainnya" class="label-lainnya me-2">Lainnya</label>
													<input type="text" class="form-login w-20" name="lainnya" id="lainnya" placeholder="" value="<?php echo $in->lainnya; ?>">
												</div>
											</div>
											<div class="col-md mb-3">
												<button class="btn bg-dark text-white mt-3 rounded-pill float-end" type="submit" value="" name="inputdatain">SAVE</button>
