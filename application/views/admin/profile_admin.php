					...
					<div class="card mb-4">
						<div class="card-header pb-0 p-sm-5">
							...
							<div class="card-profile-image mt-3 mb-4">
								...
								<img src="<?= base_url(); ?>assets/avatar/<?= $user->avatar; ?>" class="rounded mx-auto d-block" width="auto" height="170">
								<?php else : ?>
								<img src="<?= base_url(); ?>assets/img/profile.jpg" class="rounded mx-auto d-block" width="170" height="170">
								<?php endif; ?>
							</div>
							<form method="post" action="edit_profile" role="form" enctype="multipart/form-data">
								...
								<div class="container p-4">
									...
									<a href="" class="btn btn-link text-dark p-0 pt-2 mb-0 text-start" data-bs-toggle="modal" data-bs-target="#ubah_pass">
						...
						<div class="">
							<div class="card-body pb-0 px-3">
								...
								<form method="post" action="<?php echo base_url(); ?>auth/edit_pass">
									...
									<div class="row">
										<div class="">
											<h6 class="text-uppercase text-body text-xs font-weight-bolder opacity-5">
