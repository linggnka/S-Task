		...
		<div class="container-fluid py-4">
			<div class="row">
				...
				<div class="row">
					...
					<h6 class=" text-sm font-weight-bolder">Alat Tangkap: <?php echo $alat ?><a href="<?= base_url(); ?>user/dataout" class="ms-2"><i class="far fa-times-circle" style="color: #E63946"></i></a></h6>
				</div>
				<?php echo form_close()?>
				<!--End Search-->
									...
									<table class="table table-hover align-items-center mb-0">
												...
												<th class="ps-2">
													...
													<ul class="dropdown-menu" aria-labelledby="alat_tangkap">
														<form action="<?php echo base_url().'filter/filter_out_alattangkap'; ?>" method="post">
															<a class="dropdown-item border-radius-md text-xs" href="<?= base_url(); ?>dataout">Semua</a>
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap" value="Payang">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap" value="Pancing Ulur">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap" value="Jaring Rampus">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap" value="Tramel Net">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap" value="Bagan">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap" value="Pancing Tonda">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap" value="Rawai Tuna (Long Line)">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap" value="Purse Seine">
															<?php
                            								foreach ($alat_tangkap as $key): ?>
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alat_tangkap'; ?>" name="alat_tangkap2" value="<?php echo $key->alat_tangkap2 ?>">
															<?php endforeach ?>
														</form>
													</ul>
												</th>
										...
										<tbody>
											...
											<tr>
												...
												<td class="">
													<p class="mb-0 text-sm font-weight-bold"><?php echo $row['alat_tangkap'] ?><?php echo $row['alat_tangkap2'] ?></p>
												</td>
												<td class="">
												...
												<td class="">
													<p class="mb-0 text-sm font-weight-bold"><?php echo $row['es'] ?></p>
												</td>
												<td class="">
