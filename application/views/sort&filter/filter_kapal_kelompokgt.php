		...
		<div class="container-fluid py-4">
			<div class="row">
				...
				<div class="row">
					...
					<h6 class=" text-sm font-weight-bolder">GT Kapal: <?php echo $kelompok_gt ?><a href="<?= base_url(); ?>user/datakapal_user" class="ms-2"><i class="far fa-times-circle" style="color: #E63946"></i></a></h6>
				</div>
				<?php echo form_close()?>
				<!--End Search-->
									...
									<table class="table table-hover align-items-center mb-0">
										<thead>
											<tr>
												...
												<th class="ps-2">
													<p class="dropdown cursor-pointer mb-0 text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-0" id="kelompok_gt" data-bs-toggle="dropdown" aria-expanded="false">
														Kelompok GT
													...
													<ul class="dropdown-menu" aria-labelledby="alat_tangkap">
														<form action="<?php echo base_url().'filter/filter_kapal_kelompokgt'; ?>" method="post">
															<a class="dropdown-item border-radius-md text-xs" href="<?= base_url(); ?>user/datakapal_user">Semua</a>
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_kapal_kelompokgt'; ?>" name="kelompok_gt" value="<5 GT">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_kapal_kelompokgt'; ?>" name="kelompok_gt" value="5-10 GT">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_kapal_kelompokgt'; ?>" name="kelompok_gt" value="11-20 GT">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_kapal_kelompokgt'; ?>" name="kelompok_gt" value="20-30 GT">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_kapal_kelompokgt'; ?>" name="kelompok_gt" value="31-50 GT">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_kapal_kelompokgt'; ?>" name="kelompok_gt" value="51-100 GT">
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_kapal_kelompokgt'; ?>" name="kelompok_gt" value=">100 GT">
														</form>
													</ul>
												</th>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<form action="<?php echo base_url().'user/hapus_kapal'; ?>/<?= $row['id_kapal'];?>"
														method="post">
