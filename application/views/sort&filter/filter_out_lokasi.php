...
<head>
	...
	<title>
		Filter Sesuai Lokasi Keberangkatan
	</title>
	<!--     Fonts and icons     -->
		...
		<div class="container-fluid py-4">
			<div class="row">
				...
				<div class="row">
					...
					<h6 class=" text-sm font-weight-bolder">Lokasi: <?php echo $location ?><a href="<?= base_url(); ?>user/dataout" class="ms-2"><i class="far fa-times-circle" style="color: #E63946"></i></a></h6>
				</div>
				<?php echo form_close()?>
				<!--End Search-->
												...
												<th class="ps-2">
													...
													<ul class="dropdown-menu" aria-labelledby="alat_tangkap">
														<form action="<?php echo base_url().'filter/filter_out_alattangkap'; ?>" method="post">
															...
															<input type="submit" class="dropdown-item border-radius-md text-xs" href="<?php echo base_url().'filter/filter_out_alattangkap'; ?>" name="alat_tangkap2" value="<?php echo $key->alat_tangkap2 ?>">
															<?php endforeach ?>
														</form>
													</ul>
												</th>
