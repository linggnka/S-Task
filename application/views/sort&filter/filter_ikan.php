...
<head>
	...
	<title>
		Data Produksi <?php echo $awal ?> s/d <?php echo $akhir ?>
	</title>
	<!--     Fonts and icons     -->
				...
				<div class="card-header pb-0">
					<div class="card-body p-3">
						<div class="col-6 d-flex align-items-center mb-3">
							<h6 class="mb-0">Filter Data Sesuai Tanggal Keberangkatan</h6>
						</div>
						...
						<div class="row">
							<div class="col-sm-4 col-md-3 mb-4">
								<div class="border-radius-lg d-flex align-items-center flex-row">
									...
									<input type="date" class="form-control" name="tanggalawal_out" id="tanggalawal_out" placeholder="" value="<?php echo $awal ?>">
								</div>
							</div>
							<div class="col-sm-4 col-md-3 mb-4">
								<div class=" border-radius-lg d-flex align-items-center flex-row">
									<label for="" class=" me-2 my-auto">Sampai</label>
									<input type="date" class="form-control" name="tanggalakhir_out" id="tanggalakhir_out" placeholder="" value="<?php echo $akhir ?>">
								</div>
							</div>
							<div class="col-sm-4 col-md-3 mb-4">
								<div class=" border-radius-lg d-flex align-items-center flex-row">
						...
						<form action="<?php echo base_url().'user/excelfilter'; ?>" method="post">
							<div class="row">
								<div class="col-3">
									<input type="text" name="tanggalawal_out" id="" class="form-control text-center text-xxs border-0 m-0 p-0 opacity-0" style="pointer-events: none;" placeholder="" value="<?php echo $awal ?>">
								</div>
								<div class="col-3">
									<input type="text" name="tanggalakhir_out" id="" class="form-control text-center text-xxs border-0 m-0 p-0 opacity-0" style="pointer-events: none;" placeholder="" value="<?php echo $akhir ?>">
								</div>
								<div class="col-6">
									<div class=" border-radius-lg d-flex justify-content-end flex-row">
										<button type="submit" class="btn btn-link text-dark text-sm mb-0 px-0 ms-4 pt-0">
							...
							<tbody>
								...
								foreach ($datafilter as $row) : ?>
									<tr>
										...
										<td>
											<a href="<?= base_url(); ?>hapus_dataproduksi/<?= $row['id_hasil'];?>"
