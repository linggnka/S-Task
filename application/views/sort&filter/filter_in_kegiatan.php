		...
		<div class="container-fluid py-4">
			<div class="row">
				...
				<div class="row">
					...
					<h6 class=" text-sm font-weight-bolder">Kegiatan: <?php echo $kgtn ?><a href="<?= base_url(); ?>user/datain" class="ms-2"><i class="far fa-times-circle" style="color: #E63946"></i></a></h6>
				</div>
				<?php echo form_close()?>
				<!--End Search-->
									...
									<table class="table table-hover align-items-center mb-0">
												...
												<th class="ps-2">
													...
													<ul class="dropdown-menu" aria-labelledby="kegiatan">
														<form action="<?php echo base_url().'filter/filter_in_kegiatan'; ?>" method="post">
															<a class="dropdown-item border-radius-md text-xs" href="<?= base_url(); ?>datain">Semua</a>
										...
										<tbody>
											...
											<tr>
												...
												<td class="ps-0">
													<form action="<?php echo base_url().'user/hapus_datain'; ?>/<?= $row['id_in'];?>"
														method="post">
