			...
			<div class="row">
				...
				<div class="row">
					...
					<h6 class=" text-sm font-weight-bolder">Search For : <?php echo $key ?>
						<a href="<?= base_url(); ?>user/dataout" class="ms-2">
										...
										<thead>
											<tr>
												...
												<th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">
													Daerah Asal </th>
												<th class="ps-2">
													<p class="dropdown cursor-pointer mb-0 text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-0" id="dropdownTable" data-bs-toggle="dropdown" aria-expanded="false">Lokasi
