			...
			<div class="row">
				...
				<div class="row">
					...
					<h6 class=" text-sm font-weight-bolder">Search For : <?php echo $key ?>
						<a href="<?= base_url(); ?>user/keberangkatan" class="ms-2">
				...
				<div class="col-12 mt-3">
					<div class="card mb-4">
						<div class="card-header pb-0 p-5">
							<h6 class="mb-4">Pendataan Keberangkatan Kapal</h6>
							<ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
								<li><a class="dropdown-item border-radius-md" href="<?= base_url(); ?>inputkolam2">Kolam 2</a></li>
							</ul>
										...
										<tbody>
											...
											<tr>
												...
												<td class="px-4">
													<div class="d-flex">
														<div class="d-flex flex-column">
															...
															<a href="inputberangkat/<?= $row['id_kapal'];?>" class="btn btn-link text-dark p-0 pt-2 mb-0">
																<i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Catat Keberangkatan
															</a>
														</div>
													</div>
												</td>
												...
												<td class="align-middle">
													<a href="rincian_kapal/<?= $row['id_kapal'];?>"
														class="btn btn-outline-primary btn-sm mb-0">Lihat Rincian Keberangkatan</a>
												</td>
											</tr>
											<?php endforeach; ?>
										</tbody>
