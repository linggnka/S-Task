...
<head>
	...
	<title>
		Search Kapal Non Aktif (<?php echo $key ?>)
	</title>
	<!--     Fonts and icons     -->
				...
				<li class="nav-item">
					...
					<div class="collapse ms-5" id="navbarkapal">
						...
						<a class="nav-link" href="<?= base_url(); ?>data_admin">
							...
							<span class="nav-link-text ms-1 fw-bold">Non Aktif</span>
						</a>
					</div>
				</li>
			</ul>
	...
	<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
		...
		<div class="container-fluid py-4">
			<div class="row">
				<!--Fitur Search-->
				<div class="row">
					<?php echo form_open('admin/search_kapalnon')?>
					<div class="row">
						<div class="col-auto">
						...
						<h6 class=" text-sm font-weight-bolder">Search For: <?php echo $key ?><a href="<?= base_url(); ?>admin/datakapal_admin2" class="ms-2"><i class="far fa-times-circle" style="color: #E63946"></i></a></h6>
					</div>
					<?php echo form_close()?>
				</div>
				<!--End Search-->
				<div class="col-12 mt-3">
					<div class="card mb-4">
						<div class="card-header pb-0 p-5">
							<h6 class="fw-bold montserrat mb-3">Daftar Kapal Non Aktif</h6>
