		...
		<div class="container-fluid py-4">
			<div class="row">
				...
				<div class="row">
					...
					<h6 class=" text-sm font-weight-bolder">Search For: <?php echo $key ?><a href="<?= base_url(); ?>admin/data_user" class="ms-2"><i class="far fa-times-circle" style="color: #E63946"></i></a></h6>
				</div>
				<?php echo form_close()?>
				<!--End Search-->
				<div class="col-12 mt-3">
					<div class="card mb-4">
						<div class="card-header pb-0 p-sm-5">
							<h6 class="fw-bolder mb-3">Data User</h6>
									...
									<table class="table table-hover align-items-center mb-0">
										...
										<tbody>
											...
											<tr>
												...
												<form method="post" action="<?php echo base_url(); ?>auth/edit_passuser">
													<td>
														<input value="<?php echo $row['id_user']; ?>" type="hidden" name="id_user">
														<input type="text" name="password" class="text-dark px-3 mb-0 form-control" placeholder="Masukkan Password Baru" aria-describedby="button-addon2" required="">
													</td>
													<td>
